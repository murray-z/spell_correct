...
corpus_path = os.path.join(CURRENT_DIR, 'data', '水浒传.txt')
stopwords_path = os.path.join(CURRENT_DIR, 'data', 'stopwords.txt')
pinyin_word_path = os.path.join(CURRENT_DIR, 'data', 'pinyin_word.json')
word_count_path = os.path.join(CURRENT_DIR, 'data', 'word_count.json')


class SpellCorrect():
    def __init__(self, corpus_path=corpus_path, train=True, ret_num=10):
        """
        ...
        self.pinyin_word = self.load_json(pinyin_word_path)
    ...
    def split_text(self):
        ...
        self.dump_json(word_count, word_count_path)
        self.dump_json(pinyin_word, pinyin_word_path)
